...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Hotel")}}</h1>
        </div>
        ...
        <div class="row">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body panel-index">
                        <form action="" method="post">
                            @csrf
                            @include('Hotel::admin/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/hotel/editBulk')}}"
                            ...
                            <table class="table table-hover">
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{url('admin/module/hotel/edit/'.$row->id)}}">{{$prefix.' '.$row->name}}</a>
                                        </td>
